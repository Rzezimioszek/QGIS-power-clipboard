...
SOURCES = \
	__init__.py \
	power_clipboard.py power_clipboard_dockwidget.py

PLUGINNAME = power_clipboard

PY_FILES = \
	__init__.py \
	power_clipboard.py power_clipboard_dockwidget.py

UI_FILES = power_clipboard_dockwidget_base.ui
...
QGISDIR=C:\Users\BG-P\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
